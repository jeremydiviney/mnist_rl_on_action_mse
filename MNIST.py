...
class PolicyLoss(nn.Module):
    ...
    def forward(self, predictions, labels):
        ...
        if self.calc_type == 0:
            ...
            action = torch.multinomial(final_predictions + 1, 1).squeeze()
            reward = torch.where(action == labels, 1, -1)
            chosen_action_probs = final_predictions[range(final_predictions.size(0)), action]
            good_loss = (1 - chosen_action_probs[reward == 1]) * 1
            bad_loss = chosen_action_probs[reward == -1] * 0
...
train_loader = torch.utils.data.DataLoader(datasets.MNIST('./data', train=True, download=True,
                                           transform=train_transform), batch_size=64, shuffle=True, num_workers=6)
...
# schedule_params = {'mode': 'min', 'factor': 0.6, 'patience': 0}
schedule_params = {'step_size': 4, 'gamma': 0.5}
...
experiments = [
    {
        ...
        'scheduler_params': schedule_params,
    ...
    {
        'name': 'MNIST RL Policy (Adam) RESNET18 calc_type=0',
        'model_fn': get_model_resnet,
        'model_params': {},
        'train_loader': train_loader,
        'val_loader': val_loader,
    ...
    {
        'name': 'MNIST RL Policy (Adam) RESNET18 calc_type=1',
        'model_fn': get_model_resnet,
        'model_params': {},
        'train_loader': train_loader,
        'val_loader': val_loader,
    ...
    {
        'name': 'MNIST RL Policy (Adam) RESNET18 calc_type=2',
        'model_fn': get_model_resnet,
        'model_params': {},
        'train_loader': train_loader,
        'val_loader': val_loader,
    ...
    {
        'name': 'MNIST RL Policy (Adam) RESNET18 calc_type=3',
        'model_fn': get_model_resnet,
        'model_params': {},
        'train_loader': train_loader,
        'val_loader': val_loader,
    ...
    {
        'name': 'MNIST RL Policy (Adam) RESNET18 calc_type=4',
        'model_fn': get_model_resnet,
        'model_params': {},
        'train_loader': train_loader,
        'val_loader': val_loader,
    ...
    {
        'name': 'MNIST RL Policy (Adam) RESNET18 calc_type=5',
        'model_fn': get_model_resnet,
        'model_params': {},
        'train_loader': train_loader,
        'val_loader': val_loader,
        ...
        'optimizer_class': optim.Adam,
        'optimizer_params': optimizer_params,
        'loss_fn': PolicyLoss(calc_type=5, max_prob=1),
        'num_runs': 1,
        'train_fn': train_experiment
    },
    {
        'name': 'MNIST RL Policy (Adam) RESNET18 calc_type=6',
        'model_fn': get_model_resnet,
        'model_params': {},
        'train_loader': train_loader,
        'val_loader': val_loader,
        ...
        'optimizer_class': optim.Adam,
        'optimizer_params': optimizer_params,
        'loss_fn': PolicyLoss(calc_type=6, max_prob=1),
        'num_runs': 1,
        'train_fn': train_experiment
    },
